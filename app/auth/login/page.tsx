    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:block relative w-1/2">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/60">
          ...
          <p className="text-sm text-white/80 max-w-xs">Ethiopia — the birthplace of coffee, home of ancient civilizations, and one of Africa&lsquo;s most captivating destinations.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 px-8 py-12 bg-background">
        <div className="w-full max-w-sm">
          <Image src="/images/flag-ethiopia.jpg" alt="Ethiopian Flag" width={128} height={128} className="object-cover rounded-xl mx-auto mb-6" priority />
